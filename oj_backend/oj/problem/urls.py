...
urlpatterns=[
    ...
    path("problem_detail/<int:class_name>/<int:problem_id>",admin.problem_detail,name="problem_detail"),#show problem_detail need problem_id,class_name not use but need
